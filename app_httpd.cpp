...
<html>
  ...
  page += R"(</tr> 
      ...
      <tr>
        ...
        <td colspan=2>
          <div class="slidecontainer">
            <input type="range" min="0" max="255" value="0" class="slider" id="Light" oninput='sendButtonInput("ledon2","input", value)'>
          </div>
        </td>   
      </tr>
      <tr>
...
static esp_err_t ledon2_handler(httpd_req_t *req){
    char *buf = NULL;
    ...
    int led_light_val = parse_get_var(buf, "input", 0);
    free(buf);
...
void startCameraServer(){
    ...
    httpd_uri_t ledon2_uri = {
        .uri       = "/ledon2",
        .method    = HTTP_GET,
        .handler   = ledon2_handler,
        .user_ctx  = NULL
    };
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &ledon2_uri);
